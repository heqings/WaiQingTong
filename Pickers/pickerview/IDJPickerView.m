...
- (void)_setBackgroundImage {
    ...
    //ios5.0以下
    bgImage.image=[self.bg stretchableImageWithLeftCapWidth:self.bg.size.height/2 topCapHeight:self.bg.size.width/2];
//ios 5.0
...
//ios5.0以下    
    wheelCenterView.image=[self.picker_wheel_center stretchableImageWithLeftCapWidth:0 topCapHeight:0];
//ios5.0    
...
//ios5.0以下    
    selectionCenterView.image=[self.picker_selection_center stretchableImageWithLeftCapWidth:0 topCapHeight:0];
//ios5.0    
