...
@interface IDJPickerView : UIView <UITableViewDataSource, UITableViewDelegate, IDJScrollComponentDelegate> {
    ...
    id<IDJPickerViewDelegate> __unsafe_unretained delegate;
...
@property (nonatomic, unsafe_unretained) id<IDJPickerViewDelegate> delegate;
@property (nonatomic, strong) UIImage *bg;
@property (nonatomic, strong) UIImage *picker_wheel_left;
@property (nonatomic, strong) UIImage *picker_wheel_right;
@property (nonatomic, strong) UIImage *picker_wheel_center;
@property (nonatomic, strong) UIImage *picker_wheel_seperated_line;
@property (nonatomic, strong) UIImage *picker_selection_left;
@property (nonatomic, strong) UIImage *picker_selection_right;
@property (nonatomic, strong) UIImage *picker_selection_center;
